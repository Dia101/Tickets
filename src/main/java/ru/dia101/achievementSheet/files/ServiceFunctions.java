...
import ru.dia101.ticket.files.functions.FindAll;
import ru.dia101.ticket.files.functions.Func2Args;
import ru.dia101.ticket.files.functions.VoidReturnFunc;
...
public class ServiceFunctions {
    ...
    public <ResType, PropType> ResponseWithStatus<ResType> findByWithJoin(
            PropType property,
            Function<PropType, List<Object[]>> findFunction,
            Function<List<Object[]>, ResType> mapFunction
    ) {
